...
public class NetTopology extends JPanel
{
	...
	private void setUpRenderers()
	{
        ...
        try
        {
			BufferedImage image = ImageIO.read(new File("images/device/Box.png"));
	        nodeRenderer.getImageFactory().addImage("Box", image);
	        
	        image = ImageIO.read(new File("images/device/BS.png"));
	        nodeRenderer.getImageFactory().addImage("BS", image);
	        
	        image = ImageIO.read(new File("images/device/Cloud.png"));
	        nodeRenderer.getImageFactory().addImage("Cloud", image);
	        
	        image = ImageIO.read(new File("images/device/Mobile.png"));
	        nodeRenderer.getImageFactory().addImage("Mobile", image);
	        
	        image = ImageIO.read(new File("images/device/PC.png"));
	        nodeRenderer.getImageFactory().addImage("PC", image);
	        
	        image = ImageIO.read(new File("images/device/POP_high.png"));
	        nodeRenderer.getImageFactory().addImage("POP_high", image);
	        
	        image = ImageIO.read(new File("images/device/POP_low.png"));
...
//        ColorAction edges = new ColorAction(EDGES, VisualItem.STROKECOLOR, ColorLib.gray(200));
        ...
        ColorAction aggFill = new DataColorAction(AGGR, "id",
